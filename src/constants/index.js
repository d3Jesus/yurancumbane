...
export const projects = [
    {
        "id": 1,
        "imageUrl": "/explorer-notes.webp",
        "imageAlt": "explorer notes image",
        "title": "Explorer Notes",
        "description": "Turn your adventures into stories that inspire others to explore, dream, and go",
        "demo": "https://explorernotes.onrender.com",
        "source": "",
        "delay": "100",
    },
    {
...
export const workExperience = [
    ...
    },
    {
        "id": 4,
        "position": "Computer Course Trainer",
        "company": "Manjar Qb Vocational Training Center",
        "achivements": "Preparation of basic and advanced computer classes; preparation and teaching material and test where the main content was typing, MS Office package(Word, Excel, PowerPoint and Publisher); graphic editing with Photoshop and internet.",
    ...
    },
    {
        ...
        "tools": ["Windows Form", "SQL Server", "JavaScript", "Visual Basic", "UiPath Studio", "drawio/UML", "C#"],
        "delay": "500"
    }
];
...
export const socials = [
    ...
    },
    {
        "id": 4,
        "icon": faInstagram,
        "link": "https://www.instagram.com/yuran_de_jesus"
    }
]